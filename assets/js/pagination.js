window.addEventListener('DOMContentLoaded', function() {
    ...
    // popup for desktop and tablet
    function popupPokemon(item) {
        let typePokemonString = popUpType(item);
    ...
    function popUpType(item) {
        let typePopUp = item.type;

        let type = typePopUp.map((item) => {
            let typeHandle = [];
            switch (true) {
                case ['Stile', 'Dark', 'Rock'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #A1A1A1; box-shadow: 0px 4px 1px -1px #464646;">${item}</span>`);
                    break;
                case ['Grass', 'Bug'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #70A83B; box-shadow: 0px 4px 1px -1px #3f5f21;">${item}</span>`);
                    break;
                case ['Ice', 'Water'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #A2CFF0; box-shadow: 0px 4px 1px -1px #7897ad;">${item}</span>`);
                    break;
                case ['Fire', 'Fighting', 'Dragon'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item"  style="background-color: #F76545;box-shadow: 0px 4px 1px -1px #be4f36;">${item}</span>`);
                    break;
                case ['Normal', 'Gosth'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #76AADB;box-shadow: 0px 4px 1px -1px #517ca5;">${item}</span>`);
                    break;
                case ['Poison', 'Psychic', 'Fairy', 'Ghost'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #A974BC; box-shadow: 0px 4px 1px -1px #7c588a">${item}</span>`);
                    break;
                case ['Ground'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #9B897B ;box-shadow: 0px 4px 1px -1px #645a52">${item}</span>`);
                    break;
                case ['Electric'].includes(item):
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #F7C545; box-shadow: 0px 4px 1px -1px #d3a227">${item}</span>`);
                    break;
                default:
                    typeHandle.push(`<span class="pokemon-type__item" style="background-color: #3dc7ef; box-shadow: 0px 4px 1px -1px #2c88a1">${item}</span>`);
                    break;
